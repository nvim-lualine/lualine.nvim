...
M.sources = {
  nvim_lsp = function()
    local error_count = #vim.lsp.diagnostic.get(0, {severity = vim.diagnostic.severity.ERROR})
    local warning_count = #vim.lsp.diagnostic.get(0, {severity = vim.diagnostic.severity.WARN})
    local info_count = #vim.lsp.diagnostic.get(0, {severity = vim.diagnostic.severity.INFO})
    local hint_count = #vim.lsp.diagnostic.get(0, {severity = vim.diagnostic.severity.HINT})
