...
`cosmicink` is a dynamic and vibrant theme that leverages the power of the [wal](https://github.com/dylanaraps/pywal) tool to generate colors automatically. It reads the color palette generated by `wal` (a Python tool that creates colors based on your system's wallpaper) and applies it to your Neovim setup. This allows for a unique and adaptive experience every time the wallpaper changes.

If the `wal` files do not exist or cannot be found, `cosmicink` gracefully falls back to its default color theme, ensuring that your editor remains functional and visually appealing, no matter what.

<p>
<img width='700' src='https://github.com/user-attachments/assets/c8d3e4ba-4997-42e9-a1bb-d5e2a444bbfd'/>
<img width='700' src='https://github.com/user-attachments/assets/9e1c4362-7ab4-4888-b99b-bea1b5c8746d'/>
<img width='700' src='https://github.com/user-attachments/assets/09e94548-e647-422b-91cb-90654e1ab2b6'/>
<img width='700' src='https://github.com/user-attachments/assets/cf1e0526-a210-4c60-b97d-6951cefcf411'/>
</p>
